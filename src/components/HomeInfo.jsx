...
const renderContent = {
    1: (
        ...
        neo-brutalism-blue py-4 px-8 text-white mx-5 '>
            Hi, I am <span className='font-semibold'>Naeem</span>👋
            <br />
    ...
    2: (
        <InfoBox
            text="Gained a rich tapestry of 5-year experience spanning reputable firms in meticulously honed my skills"
            link="/about"
            btnText="Learn More"
        />
    ),
